...
async def send_message(
    ...
    try:
        # Records written here are real — a ticket goes into the same
        # dispatch queue a phone call's does — so its emergency alert is
        # queued with it (the outbox) and sent once this request commits.
